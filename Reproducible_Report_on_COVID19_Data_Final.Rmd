...
I am seeking to start with the analysis presented in class and extend it a bit to an area of interest of mine, public health. I'm curious to see the affect of vaccination rates on COVID cases and deaths from when merged with the original Hopkins dataset.
Note:
...
## Load a new dataset for vaccination rates in the USA to examine relationship between population vaccination rates and death rates
I wanted to see how vaccination rates affected the total deaths and case data, taken at the end of each period of record for each administrative area (i.e. unique FIPS ID). There is a rich dataset from the CDC with vaccination rates over the same areas of aggregation for the JHU dataset. Vaccine eligible to all USA on 2021-04-19.
